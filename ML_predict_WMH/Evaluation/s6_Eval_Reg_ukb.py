...
outfile1 = dpath + 'Results/RM_BL_BD/Evaluations/RegEval/s6_Eval_ukb.csv'
outfile2 = dpath + 'Results/RM_BL_BD/Evaluations/RegEval/s6_Eval_ukb_summary.csv'
mydf = pd.read_csv(dpath + 'Results/RM_BL_BD/s5_Pred.csv')
...
outfile11 = dpath + 'Results/RM_BL_BD/Evaluations/RegEval/s6_Eval_raw_ukb.csv'
outfile21 = dpath + 'Results/RM_BL_BD/Evaluations/RegEval/s6_Eval_raw_ukb_summary.csv'
