...
outfile1 = dpath + 'Results/RM_BL_BD/Evaluations/RegEval/s6_Eval_yy.csv'
outfile2 = dpath + 'Results/RM_BL_BD/Evaluations/RegEval/s6_Eval_yy_summary.csv'
mydf = pd.read_csv(dpath + 'Results/RM_BL_BD/s5_Pred_YueYang.csv')
mydf.dropna(how = 'any', inplace = True)
results_df, myout_df = get_avg_output(mydf, nb_iters=2000)

results_df.to_csv(outfile1, index = False)
myout_df.to_csv(outfile2)


outfile11 = dpath + 'Results/RM_BL_BD/Evaluations/RegEval/s6_Eval_raw_yy.csv'
outfile21 = dpath + 'Results/RM_BL_BD/Evaluations/RegEval/s6_Eval_raw_yy_summary.csv'
