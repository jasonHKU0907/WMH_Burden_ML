...
outfile1 = dpath + 'Results/RM_BL_BD/Evaluations/RegEval/s6_Eval_ukb_24486.csv'
outfile2 = dpath + 'Results/RM_BL_BD/Evaluations/RegEval/s6_Eval_ukb_24486_summary.csv'
mydf = pd.read_csv(dpath + 'Results/RM_BL_BD/s5_Pred_x24486_2_0.csv')
...
outfile11 = dpath + 'Results/RM_BL_BD/Evaluations/RegEval/s6_Eval_raw_ukb_24486.csv'
outfile21 = dpath + 'Results/RM_BL_BD/Evaluations/RegEval/s6_Eval_raw_ukb_24486_summary.csv'
